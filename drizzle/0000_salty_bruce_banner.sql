...
ALTER TABLE "products" ADD CONSTRAINT "products_default_variant_id_product_variants_id_fk" FOREIGN KEY ("default_variant_id") REFERENCES "public"."product_variants"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
